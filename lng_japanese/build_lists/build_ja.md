Di seguito sono presenti due script completi:

* `build_core_ja_from_bccwj.py`

Fonti consigliate: per il giapponese BCCWJ Word List, perché la lista di frequenza BCCWJ è pubblica e gratuita per uso di ricerca o didattico. 
BCCWJ Word List: [https://clrd.ninjal.ac.jp/bccwj/en/freq-list.html](https://clrd.ninjal.ac.jp/bccwj/en/freq-list.html). ([ACL Anthology][1])


## Script - Giapponese da BCCWJ Word List
...
Uso tipico con file BCCWJ scaricato manualmente:
...
Uso con colonne esplicite, se l’auto-detect non riconosce il file:
...
Il BCCWJ è uno dei riferimenti principali per il giapponese contemporaneo scritto; la pagina ufficiale della BCCWJ Word List dice che la lista di frequenza è disponibile pubblicamente e gratuita per ricerca/didattica. URL: [https://clrd.ninjal.ac.jp/bccwj/en/freq-list.html](https://clrd.ninjal.ac.jp/bccwj/en/freq-list.html). ([clrd.ninjal.ac.jp][3])

File: `build_core_ja_from_bccwj.py`
...
```
core_1000_ja.csv      rank 1-1000
core_2000_ja.csv      rank 1001-2000
core_3000_ja.csv      rank 2001-3000
core_4000_ja.csv      rank 3001-4000
core_5000_ja.csv      rank 4001-5000
```

In più genera:

```
core_0001_5000_ja.csv
```

che contengono la lista completa con rank assoluto.

## Limiti da ricordare

Per il giapponese, BCCWJ è una base molto solida per frequenze scritte, ma non sostituisce una revisione didattica manuale e non coincide automaticamente con liste JLPT o con liste “Core 2k/6k” diffuse in Anki. Wiktionary elenca anche liste giapponesi derivate da Wikipedia e segnala l’esistenza di liste 1-10.000/20.000 basate su diversi analizzatori; queste sono utili come fonti alternative o di confronto. URL: [https://en.wiktionary.org/wiki/Wiktionary:Frequency_lists/Japanese](https://en.wiktionary.org/wiki/Wiktionary:Frequency_lists/Japanese). ([Wiktionary][4])

[1]: https://aclanthology.org/L12-1154/?utm_source=chatgpt.com "Building Large Monolingual Dictionaries at the Leipzig ..."
[2]: https://en.wiktionary.org/wiki/Wiktionary%3AFrequency_lists?utm_source=chatgpt.com "Wiktionary:Frequency lists"
[3]: https://clrd.ninjal.ac.jp/bccwj/en/freq-list.html?utm_source=chatgpt.com "BCCWJ Word List"
[4]: https://en.wiktionary.org/wiki/Wiktionary%3AFrequency_lists/Japanese?utm_source=chatgpt.com "Wiktionary:Frequency lists/Japanese"
